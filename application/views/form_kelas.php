                                    ...
                                    <div class="card-body">
                                       ...
                                       <?php echo form_open('Admin/simpan_kelas');?>
                                            <div class="form-group">
                                                ...
                                                <?php echo form_input("kode_kelas", set_value ('kode_kelas'),array ('class'=>'form-control', 'id'=>'kk',
                                            ...
                                            <div class="form-group">
                                                ...
                                                <?php echo form_input("nama_kelas", set_value ('nama_kelas'),array('class'=>'form-control', 'id'=>'nk',
